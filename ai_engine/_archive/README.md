...
- `backfill_stakes__pre_kelly_unified_2026-04-19.py`
  - Script backfill retroattivo. Identico ad A/S. Dopo l'intervento rinominato in produzione in `backfill_stakes_legacy.py` (non modificato, non invocato da pipeline).
